  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-black text-white">
      ...
      <main className="relative z-10 flex max-w-3xl flex-col items-center gap-6 px-4 text-center">
        ...
        <Link
          href="/music"
          className="inline-flex items-center justify-center border border-white/70 px-8 py-2 text-xs uppercase tracking-[0.25em] transition hover:bg-white hover:text-black">
          Listen
        </Link>

        <Link
          href="/about"
          className="inline-flex items-center justify-center border border-white/30 bg-white/5 px-8 py-2 text-xs uppercase tracking-[0.25em] transition hover:border-white hover:bg-white hover:text-black">
          About
        </Link>
      </div>
      </main>
