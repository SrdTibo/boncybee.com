  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-black text-white">
      <div className="pointer-events-none absolute inset-0">
        <Image src="/set.JPG" alt="Boncybee live set" fill priority className="object-cover opacity-70" />
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/70 to-black/30" />
      </div>
      <Navbar />
      <main className="relative z-10 flex max-w-3xl flex-col items-center gap-6 px-4 text-center">
        <div className="mb-2 flex items-center justify-center">
          <Image src="/LogoWhiteNoBack.png" alt="Boncybee logo" width={250} height={250} className="drop-shadow-[0_0_35px_rgba(255,255,255,0.4)]" />
        </div>
